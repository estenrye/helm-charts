...
```bash
helm install vscode-server estenrye-helm-charts/vscode-server 0.3.7
```
...
helm install vscode-server estenrye-helm-charts/vscode-server --namespace vscode-server --version 0.3.7
```
