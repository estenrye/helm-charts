...
```bash
helm install fluentd-aws-cloudtrail-processor estenrye-helm-charts/fluentd-aws-cloudtrail-processor 0.0.19
```
...
helm install fluentd-aws-cloudtrail-processor estenrye-helm-charts/fluentd-aws-cloudtrail-processor --namespace fluentd-aws-cloudtrail-processor --version 0.0.19
```
...
| fluentd.enable_elasticsearch | bool | `false` | Enable Output to Elasticsearch |
| fluentd.enable_stdout | bool | `true` | Enable Output to Standard Out of Split Records |
| fluentd.enable_stdout_raw | bool | `false` | Enable Output to Standard Out of Raw CloudTrail Logs |
