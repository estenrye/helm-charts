...
```bash
helm install fluentd-aws-cloudtrail-processor estenrye-helm-charts/fluentd-aws-cloudtrail-processor 0.1.1
```
...
helm install fluentd-aws-cloudtrail-processor estenrye-helm-charts/fluentd-aws-cloudtrail-processor --namespace fluentd-aws-cloudtrail-processor --version 0.1.1
```
